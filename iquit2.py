...
def motors(quad):
    ...
    try:
        ...
        duration_stepper = duration_values.get(material_quadrant, 2)
        final_duration_stepper = final_duration_values.get(material_quadrant, 2)
...
def stepperRotation(quadrant):
    ...
    try:
        ...
        rotate_to_quadrant(paper,1)  #**CHANGE THE MATERIAL HERE
        sleep(1)
        rotate(17)
        sleep(1)
        rotate_to_quadrant(paper,0)  #**CHANGE THE MATERIAL HERE
